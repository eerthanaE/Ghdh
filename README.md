...
<body>
    ...
    <section id="resume">
        ...
        <div class="section-content">
            <center>
            <h2>Resume</h2>
            <a href="https://https://docs.google.com/document/d/17Or_xljSzN8OToEZuvZIKxCmDz8Vcdhh/edit?usp=drivesdk&ouid=103124436740264407921&rtpof=true&sd=trueusp=sharing" target="_blank" class="download-button">Download CV</a>
        </center>
        </div>
